...
- sistema de logros por jugador registrado (solo partidas human vs human)
...
- Profile:
  ...
  interno a `3` puntos y no se procesan en partidas contra bots. En esta iteración no hay endpoint
  REST de perfil.
- Tiempo real:
