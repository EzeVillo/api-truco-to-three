...
class ChatMessageTest {
    ...
    class Create {
        ...
        void create_nullContent_throws() {
            ...
            assertThatThrownBy(() -> ChatMessage.create(sender, null, Instant.now()))
        ...
        void create_emptyContent_throws() {
            ...
            assertThatThrownBy(() -> ChatMessage.create(sender, "", Instant.now()))
                .isInstanceOf(ChatMessageEmptyException.class);
        }
        ...
        void create_tooLongContent_throws() {
            ...
            assertThatThrownBy(() -> ChatMessage.create(sender, longContent, Instant.now()))
    ...
    class Reconstruct {
        ...
        void reconstruct_noValidation() {
            ...
            final var message = ChatMessage.reconstruct(
                ChatMessageId.generate(), sender, longContent, Instant.now());
