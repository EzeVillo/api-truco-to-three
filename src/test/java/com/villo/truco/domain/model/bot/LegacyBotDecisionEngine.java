...
/**
 * Réplica del motor del bot anterior al rediseño (pre-T016), fiel al código que orquestaba
 * {@link TrucoDecisionPolicy} + {@link EnvidoDecisionPolicy} + {@link CardSelectionPolicy}.
 *
 * <p>Vive solo en tests como adversario del motor rediseñado ({@link BotDecisionEngine}) para
 * validar SC-007 (win-rate ≥ 60% del nuevo vs. el anterior). No forma parte del dominio de
 * producción.
 */
public final class LegacyBotDecisionEngine {
  ...
  public LegacyBotDecisionEngine(final BotPersonality personality,
      final EnvidoScoring envidoScoring) {

    this(personality, new Random(), envidoScoring);
  }

  LegacyBotDecisionEngine(final BotPersonality personality, final Random random,
      final EnvidoScoring envidoScoring) {
