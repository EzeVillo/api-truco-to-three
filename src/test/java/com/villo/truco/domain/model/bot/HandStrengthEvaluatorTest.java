...
class HandStrengthEvaluatorTest {
  ...
  void contextualStrength_singleBestCard_returnsOne() {
    final var strength = HandStrengthEvaluator.contextualStrength(List.of(ANCHO_ESPADA), null,
        0);
  ...
  void contextualStrength_withRivalCard_canBeat_noReduction() {
    final var withRival = HandStrengthEvaluator.contextualStrength(List.of(ANCHO_ESPADA),
        TRES_COPA, 0);
    final var withoutRival = HandStrengthEvaluator.contextualStrength(List.of(ANCHO_ESPADA),
        null, 0);
  ...
  void contextualStrength_withRivalCard_cannotBeat_reduced() {
    final var withRival = HandStrengthEvaluator.contextualStrength(List.of(CUATRO_COPA),
        TRES_COPA, 0);
  ...
  void contextualStrength_twoCards_strongerWeightedMore() {
    final var strength = HandStrengthEvaluator.contextualStrength(
        List.of(CUATRO_COPA, TRES_COPA), null, 0);
