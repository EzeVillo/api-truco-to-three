...
class ChatTest {
  ...
  class Create {
    ...
    void createChat_lessThanTwoParticipants_throws() {
      ...
      assertThatThrownBy(() -> Chat.create(ChatParentType.MATCH, "id", Set.of(playerOne),
  ...
  class SendMessage {
    ...
    void sendMessage_nonParticipant_throws() {
      ...
      assertThatThrownBy(() -> chat.sendMessage(stranger, "Hi")).isInstanceOf(
    ...
    void sendMessage_emptyContent_throws() {
      ...
      assertThatThrownBy(() -> chat.sendMessage(playerOne, "")).isInstanceOf(
    ...
    void sendMessage_nullContent_throws() {
      ...
      assertThatThrownBy(() -> chat.sendMessage(playerOne, null)).isInstanceOf(
          ChatMessageEmptyException.class);
    }
    ...
    void sendMessage_tooLong_throws() {
      ...
      assertThatThrownBy(() -> chat.sendMessage(playerOne, longContent)).isInstanceOf(
  ...
  class RateLimit {
    ...
    void sendMessage_rateLimited_throws() {
      ...
      assertThatThrownBy(() -> chat.sendMessage(playerOne, "second")).isInstanceOf(
          ChatRateLimitExceededException.class);
    }
  ...
  class ValidateParticipant {
    ...
    void validateParticipant_invalid_throws() {
      ...
      assertThatThrownBy(() -> chat.validateParticipant(stranger)).isInstanceOf(
          PlayerNotInChatException.class);
    }
