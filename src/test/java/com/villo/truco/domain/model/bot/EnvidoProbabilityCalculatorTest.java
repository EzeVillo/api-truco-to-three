...
class EnvidoProbabilityCalculatorTest {
  ...
  void maxEnvidoAsMano_winsAlmostAlways() {
    ...
    final var probability = EnvidoProbabilityCalculator.probabilityBotWinsTanto(SCORING, myCards, 33, true,
        null);
  ...
  void lowEnvidoAsMano_isUnderdog() {
    ...
    final var probability = EnvidoProbabilityCalculator.probabilityBotWinsTanto(SCORING, myCards, 7, true,
        null);
  ...
  void envido22AsMano_isNearCoinFlip() {
    ...
    final var probability = EnvidoProbabilityCalculator.probabilityBotWinsTanto(SCORING, myCards, 22, true,
        null);
  ...
  void rivalShownCardConditionsTheEstimate() {
    ...
    final var withHighTantoCard = EnvidoProbabilityCalculator.probabilityBotWinsTanto(SCORING, myCards, 22,
        false, card(Suit.ORO, 7));
    final var withLowTantoCard = EnvidoProbabilityCalculator.probabilityBotWinsTanto(SCORING, myCards, 22,
