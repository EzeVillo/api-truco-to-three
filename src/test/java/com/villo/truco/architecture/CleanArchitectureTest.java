...
class CleanArchitectureTest {
  ...
  static final ArchRule profile_layered_architecture_must_be_respected = layeredArchitecture().consideringOnlyDependenciesInLayers()
      ...
      .whereLayer("ProfileDomain")
      .mayOnlyBeAccessedByLayers("ProfileApplication", "ProfileInfrastructure")
      .whereLayer("ProfileApplication").mayOnlyBeAccessedByLayers("ProfileInfrastructure")
      .whereLayer("ProfileInfrastructure").mayNotBeAccessedByAnyLayer();
