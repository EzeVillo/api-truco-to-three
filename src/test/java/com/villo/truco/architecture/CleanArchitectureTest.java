...
class CleanArchitectureTest {
    ...
    @ArchTest
    static final ArchRule layered_architecture_must_be_respected = layeredArchitecture()
    ...
    @ArchTest
    static final ArchRule domain_must_not_depend_on_application_or_infrastructure_or_spring =
    ...
    @ArchTest
    static final ArchRule http_layer_must_use_input_ports_not_usecase_implementations =
        ArchRuleDefinition.noClasses()
            .that().resideInAPackage("..infrastructure.http..")
