...
class ChatCupStartedEventHandlerTest {
    ...
    void setUp() {
        ...
        this.handler = new ChatCupStartedEventHandler(this.chatRepository,
    ...
    void createsOnCupStarted() {
        ...
        this.handler.handle(new CupStartedEvent(cupId), new CupEventContext(cupId, participants));
    ...
    void doesNotCreateDuplicate() {
        ...
        this.handler.handle(new CupStartedEvent(cupId),
            new CupEventContext(cupId, List.of(PlayerId.generate())));
