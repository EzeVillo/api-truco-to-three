...
class ChatMatchFinishedEventHandlerTest {
  ...
  void setUp() {
    ...
    this.handler = new ChatMatchFinishedEventHandler(this.chatRepository, this.chatQueryRepository);
  }
  ...
  void deletesChat() {
    ...
    this.handler.handle(new MatchFinishedEvent(matchId, PlayerId.generate(), PlayerId.generate(),
