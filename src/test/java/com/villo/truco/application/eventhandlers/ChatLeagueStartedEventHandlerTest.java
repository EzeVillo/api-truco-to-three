...
class ChatLeagueStartedEventHandlerTest {
    ...
    void setUp() {
        ...
        this.handler = new ChatLeagueStartedEventHandler(this.chatRepository,
    ...
    void createsOnLeagueStarted() {
        ...
        this.handler.handle(new LeagueStartedEvent(leagueId),
            new LeagueEventContext(leagueId, participants));
    ...
    void doesNotCreateDuplicate() {
        ...
        this.handler.handle(new LeagueStartedEvent(leagueId),
            new LeagueEventContext(leagueId, List.of(PlayerId.generate())));
