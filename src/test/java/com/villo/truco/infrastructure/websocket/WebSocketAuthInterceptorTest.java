...
class WebSocketAuthInterceptorTest {
  ...
  @Test
  void shouldAllowSubscribeToProfileQueueWhenAuthenticated() {
    ...
    attrs.put("authenticatedPlayer", UUID.randomUUID().toString());
    accessor.setSessionAttributes(attrs);
    accessor.setDestination("/user/queue/profile");
  ...
  @Test
  void shouldAllowSubscribeToCampaignQueueWhenAuthenticated() {
    ...
    attrs.put("authenticatedPlayer", UUID.randomUUID().toString());
    accessor.setSessionAttributes(attrs);
    accessor.setDestination("/user/queue/campaign");
