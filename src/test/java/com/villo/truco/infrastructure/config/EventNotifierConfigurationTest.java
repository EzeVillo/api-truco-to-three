...
class EventNotifierConfigurationTest {
  ...
  void buildsNotifierBeans() {
    ...
    final var configuration = new EventNotifierConfiguration(
        ...
        mock(MatchDomainEventHandler.class), mock(CupDomainEventHandler.class),
        mock(LeagueDomainEventHandler.class));
    ...
    assertThat(configuration.matchEventNotifier(mock(MatchPresenceEventTranslator.class),
        ...
        mock(CampaignMatchDomainEventHandler.class),
        mock(HistoryMatchDomainEventHandler.class))).isNotNull();
