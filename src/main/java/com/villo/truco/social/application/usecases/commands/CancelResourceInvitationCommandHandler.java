...
public final class CancelResourceInvitationCommandHandler implements
    CancelResourceInvitationUseCase {
  ...
  public CancelResourceInvitationCommandHandler(final SocialUserGuard socialUserGuard,
  ...
  @Override
  public ResourceInvitationDTO handle(final CancelResourceInvitationCommand command) {
    ...
    invitation.cancel(command.actorId());
