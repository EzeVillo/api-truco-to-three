...
public record AcceptResourceInvitationCommand(ResourceInvitationId invitationId, PlayerId actorId) {

  public AcceptResourceInvitationCommand {

    Objects.requireNonNull(invitationId);
    Objects.requireNonNull(actorId);
  }

  public AcceptResourceInvitationCommand(final String invitationId, final String actorId) {
