...
public final class ResourceInvitationExpiredEvent extends ResourceInvitationDomainEvent {

  public ResourceInvitationExpiredEvent(final ResourceInvitationId invitationId,
    ...
    super("RESOURCE_INVITATION_EXPIRED", invitationId, senderId, recipientId, targetType, targetId,
        ResourceInvitationStatus.EXPIRED, expiresAt, List.of(senderId, recipientId));
  }
