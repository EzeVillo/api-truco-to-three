...
import com.villo.truco.infrastructure.aot.ExecutorRuntimeHints;
import com.villo.truco.infrastructure.aot.LazyInjectionProxyRuntimeHints;
...
@ImportRuntimeHints({WebSocketPayloadRuntimeHints.class, PersistenceRuntimeHints.class,
    LazyInjectionProxyRuntimeHints.class, ExecutorRuntimeHints.class})
