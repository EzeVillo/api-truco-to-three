...
public record ChatMessagesResponse(
    ...
    @Schema(description = "Estado de envio del jugador autenticado") ChatSendStateResponse sendState,
    @Schema(description = "Mensajes del chat, maximo 50") List<ChatMessageResponse> messages) {
  ...
  public static ChatMessagesResponse from(final ChatMessagesDTO dto) {
    ...
    return new ChatMessagesResponse(dto.chatId(), dto.parentType(), dto.parentId(),
        ChatSendStateResponse.from(dto.sendState()),
