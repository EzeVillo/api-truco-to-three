...
public record GetPublicMatchesQuery(PlayerId playerId, CursorPageQuery pageQuery) {

  public static final int MAX_LIMIT = 100;

  public GetPublicMatchesQuery(final String playerId, final int limit, final String after) {
