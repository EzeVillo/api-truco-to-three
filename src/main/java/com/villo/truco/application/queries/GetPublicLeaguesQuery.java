...
public record GetPublicLeaguesQuery(PlayerId playerId, CursorPageQuery pageQuery) {

  public static final int MAX_LIMIT = 100;

  public GetPublicLeaguesQuery(final String playerId, final int limit, final String after) {
