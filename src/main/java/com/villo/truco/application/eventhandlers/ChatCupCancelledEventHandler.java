...
public final class ChatCupCancelledEventHandler
    implements CupDomainEventHandler<CupCancelledEvent> {
    ...
    @Override
    public void handle(final CupCancelledEvent event, final CupEventContext context) {
