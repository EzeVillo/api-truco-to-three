 ...
 * ingreso a una partida ({@link PlayerJoinedEvent}) y su liberacion (finalizada, cancelada,
...
public final class MatchPresenceEventTranslator implements
  ...
  private static boolean isOccupancyTransition(final MatchDomainEvent event) {
    ...
    return event instanceof PlayerJoinedEvent || event instanceof MatchFinishedEvent
