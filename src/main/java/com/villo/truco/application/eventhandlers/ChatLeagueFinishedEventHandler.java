...
public final class ChatLeagueFinishedEventHandler implements
    LeagueDomainEventHandler<LeagueFinishedEvent> {
  ...
  @Override
  public void handle(final LeagueFinishedEvent event) {
